...
RSpec.describe 'transactions request ', type: :request do
  ...
  describe "sad paths for spending points" do
    it 'lets you know if you dont have sufficent funds ' do
      ...
      get '/user/transactions/spend', params: { points: 1000000}
      ...
      expect(transaction_data[:error]).to eq("insufficent funds")
    end
